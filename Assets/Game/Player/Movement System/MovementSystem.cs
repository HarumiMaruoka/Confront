...
namespace Confront.Physics
{
    public class MovementSystem
    {
        ...
        public MovementSystem(CharacterController controller, MovementSettings settings, GroundSensor groundSensor, LayerController layerController)
        {
        ...
        public void Update(float inputX)
        {
            ...
            _groundSensorResult = _groundSensor.CheckGround(_controller.transform.position, Vector2.down, _controller.slopeLimit, _isAscendingDueToJump, _layerController.IsInColliderDisableZone);
