...
namespace Confront.ActionItem
{
    ...
    {
        [SerializeField]
        private ActionItemData _item;
        [SerializeField]
        private int _count;

        public ActionItemData Item // スロットに格納されているアイテム
        {
            get => _item; set
            {
                _item = value;
        ...
        public int AddItem(ActionItemData newItem, int amount)
        {
        ...
        public int RemoveItem(ActionItemData item, int amount)
        {
