...
/// </summary>
[System.Serializable]
public abstract class Base_WeaponTMUseRay : Base_WeaponTN, IOnEnemyDamage
{
    protected RaycastHit _hitInfo = default;
    protected readonly float _maxDistance = default;

    // コンストラクタ
    public Base_WeaponTMUseRay(GameObject bulletPrefab, PWeaponComponent pWeaponComponent,float maxDistance) :
